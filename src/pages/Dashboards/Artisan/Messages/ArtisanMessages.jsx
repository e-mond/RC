  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <header className="mb-6">
        <h2 className="text-2xl font-bold text-[#0f1724]">Messages</h2>
        <p className="text-sm text-gray-600">Communicate with landlords and tenants</p>
      </header>
              ...
              <form onSubmit={handleSendMessage} className="p-4 border-t border-gray-200">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0b6e4f]"
                  />
                  <button
                    type="button"
  ...
  return (
    <motion.div
      ...
      className={`p-4 cursor-pointer hover:bg-gray-50 transition-colors ${
        isSelected ? "bg-[#0b6e4f]/5 border-l-4 border-[#0b6e4f]" : ""
      }`}
    >
    ...
    >
      <div
        className={`max-w-[70%] rounded-lg p-3 ${
          isOwn ? "bg-[#0b6e4f] text-white" : "bg-gray-100 text-gray-900"
        }`}
      >
