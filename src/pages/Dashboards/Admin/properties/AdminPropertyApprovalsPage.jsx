/**
 * AdminPropertyApprovalsPage - Admin Property Approvals Page
 * 
 * Full-page view for Admin to review and approve/reject pending property listings.
 * Similar to Super Admin page but uses Admin endpoints.
 * 
 * Features:
...
export default function AdminPropertyApprovalsPage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        console.log("[AdminPropertyApprovalsPage] Response:", res);
        ...
        console.log("[AdminPropertyApprovalsPage] Extracted properties:", propertyList);
  ...
  const handleBulkApprove = async () => {
    ...
    try {
      await Promise.all(ids.map((id) => approveProperty(id)));
