...
import { Bell, LogOut, ChevronDown, User, Sun, Moon, ArrowLeft, X } from "lucide-react";
      ...
      <header className="h-16 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-gray-200/60 dark:border-gray-700/60 sticky top-0 z-40 shadow-sm">
        <div className="h-full px-4 md:px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white tracking-tight truncate max-w-75 md:max-w-none">
              {getPageTitle()}
            </h1>
          </div>
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="relative">
              ...
              >
                <div className="w-10 h-10 rounded-full bg-linear-to-br from-emerald-600 to-emerald-700 flex items-center justify-center text-white font-bold shadow-md">
                  {initials}
                </div>

                <div className="hidden md:block text-left">
                  <p className="text-sm font-semibold text-gray-900 dark:text-white truncate max-w-35">
                    {displayName}
                  </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4">
          <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-6 border border-gray-200/50 dark:border-gray-700/50">
            ...
            <div className="flex gap-4 justify-end">
              <button
                onClick={() => setShowLogoutModal(false)}
                className="px-6 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 transition"
              >
                {t("Cancel")}
              </button>
              <button
                ...
                className="px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-xl transition shadow-sm"
              >
                {t("Yes Logout")}
              </button>
            </div>
