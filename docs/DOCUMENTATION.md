...
> Full architecture deep dives now live in `docs/FRONTEND.md`, `docs/BACKEND.md`, and `docs/API_ENDPOINTS.md`. This file keeps the legacy high-level summary for quick reference.
